...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/stoppa
```

A live public deployment of this template is available at [https://stoppa.templates.workers.dev](https://stoppa.templates.workers.dev)
